...
namespace ApiEmprendimiento.Migrations
{
    ...
    [Migration("20250819232210_AddCostoActualEnStockToInventarioProducto")]
    partial class AddCostoActualEnStockToInventarioProducto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiEmprendimiento.Models.ReporteFinancieroMensual", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset>("FechaUltimaActualizacion")
                        .HasColumnType("datetimeoffset");

                    b.Property<int>("Mes")
                        .HasColumnType("int");

                    b.Property<decimal>("TotalGananciasVentasMes")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TotalGastosFabricacionMes")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("ReportesFinancierosMensuales");
                });
            ...
            modelBuilder.Entity("ApiEmprendimiento.Models.DetalleVenta", b =>
                {
                    ...
                    b.HasOne("ApiEmprendimiento.Models.Venta", "Ventas")
                        .WithMany("DetallesVenta")
            ...
            modelBuilder.Entity("ApiEmprendimiento.Models.ReporteFinancieroMensual", b =>
                {
                    b.HasOne("ApiEmprendimiento.Models.Emprendimiento", "Emprendimiento")
                        .WithMany("ReportesFinancierosMensuales")
                        .HasForeignKey("EmprendimientoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ApiEmprendimiento.Models.Emprendimiento", b =>
                {
                    ...
                    b.Navigation("ReportesFinancierosMensuales");
